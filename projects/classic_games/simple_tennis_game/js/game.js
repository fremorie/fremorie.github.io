...
function moveEverything() {
  ...
  ballX += ballSpeedX;
  ballY += ballSpeedY;
  if (ballX < ballRadius + PADDLE_INDENT + PADDLE_WIDTH) {
  ...
  if (ballX > canvas.width - PADDLE_INDENT - PADDLE_WIDTH - ballRadius) {
...
function drawEverything() {
  ...
  drawRect(PADDLE_INDENT, paddle1Y, PADDLE_WIDTH, PADDLE_HEIGHT, 'white');
  // draw right player paddle
  drawRect(canvas.width - PADDLE_INDENT - PADDLE_WIDTH, paddle2Y, PADDLE_WIDTH, PADDLE_HEIGHT, 'white');
  // draw ball
